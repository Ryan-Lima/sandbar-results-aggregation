...
if __name__ =='__main__':
    ...
    #designate groups       
    g_1ab = np.char.upper(np.array(['145l','022r','213l','084r','030r','081l','137l','119r','122r','123l','172l','041r','044l','183r','220r','050r','065r','047r']))
    g_1c_3 = np.char.upper(np.array(['194l','068r','051l','055r','043l','087l','093l','139r','225r','104r'])) # '070r' dropped because it was added in 2008
    g_24 = np.char.upper(np.array(['008l','024l','029l','032r','056r','016l','033l','035l','062r','091r','202r']))# ,'167l' removed because it is a technical outlier
    ...
    for group1 in [g_1ab,g_1c_3,g_24][0:1]:
    ...
    fig.savefig(out_root + os.sep + 'Marble_Canyon_SE_Lumped_Groups_Volume.png')
#================================================================================================================================================================
    fig , (ax_0,ax_1) = plt.subplots(figsize=(7.5,6),nrows=2,sharex=True)
    r=['Groups 1a and 1b','Groups 1c and 3','Groups 2 and 4']
    n=0
    ...
    fig.tight_layout() 
    fig.subplots_adjust(bottom=0.164) 
    fig.savefig(out_root + os.sep + 'Grand_Canyon_SE_Lumped_Groups_Volume.png')
